...
@Service
public class SpringMessageSourceRepresentationService implements MessageSourceRepresentationService {
  ...
  public String getLocalePropertiesAsString(String locale) {
    Assert.notNull(locale);
    Properties properties = this.internalMessageSource.getMergedPropertiesRepresentation(new Locale(locale));
