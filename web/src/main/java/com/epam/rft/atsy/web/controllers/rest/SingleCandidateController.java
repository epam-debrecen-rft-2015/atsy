...
@RestController @RequestMapping(value = "/secure/candidate")
public class SingleCandidateController {
    ...
    public ResponseEntity saveOrUpdate(@Valid @RequestBody CandidateDTO candidateDTO,
        ...
        if (!result.hasErrors()) {
            ...
            Map<String, String> errorMessages =
                parseValidationErrors(result.getFieldErrors(), locale);
    ...
    public ResponseEntity handleDuplicateException(Locale locale, DuplicateRecordException ex) {
        ...
        return new ResponseEntity<>(messageSource
            .getMessage(DUPLICATE_CANDIDATE_ERROR_KEY, new Object[] {ex.getName()}, locale),
