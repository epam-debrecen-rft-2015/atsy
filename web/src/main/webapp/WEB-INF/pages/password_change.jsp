    ...
    <div id="password_section">
        <form role="form" method="POST" id="pw-form" action="./password">
            ...
            <div class="form-group">
                <label for="new-pw"><spring:message code="settings.password.new"/><span id="requiredMark">*</span></label>
                <input type="password" class="newPassword form-control" name="newPassword" id="new-pw">
            </div>
            <div class="form-group">
                <label for="new-pw-two"><spring:message code="settings.password.new.two"/><span id="requiredMark">*</span></label>
                <input type="password" class="newPasswordConfirm form-control" name="newPasswordConfirm" id="new-pw-two">
            </div>
            <div class="form-group">
                <label for="old-pw"><spring:message code="settings.password.old"/><span id="requiredMark">*</span></label>
