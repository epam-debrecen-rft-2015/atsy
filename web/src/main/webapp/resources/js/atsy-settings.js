...
window.channelsEvents = {
    ...
    'click .remove': function (e, value, row) {
         ...
         var options = getOptions('/secure/channels', 'question.delete.channel.js', 'selected.channel.not.found.js', row, container);
...
window.positionsEvents = {
    ...
    'click .remove': function (e, value, row) {
        ...
        var options = getOptions('/secure/positions', 'question.delete.position.js', 'selected.position.not.found.js', row, container);
        bootbox.dialog(options);
    }
};
