...
//
//  @Test
//  public void loadPageShouldRespondInternalServerErrorWhenParamSortIsAnEmptyString()
//      throws Exception {
//    this.mockMvc.perform(get(REQUEST_URL)
...
//
//  @Test
//  public void loadPageShouldRespondInternalServerErrorWhenParamOrderIsAnEmptyString()
//      throws Exception {
//    this.mockMvc.perform(get(REQUEST_URL)
...
//
//    ArgumentCaptor<FilterRequest>
//        filterRequestArgumentCaptor =
//        ArgumentCaptor.forClass(FilterRequest.class);
//    this.mockMvc.perform(get(REQUEST_URL)
...
//        ArgumentCaptor.forClass(FilterRequest.class);
//    this.mockMvc.perform(get(REQUEST_URL)
//        .param(FILTER, JSON_CANDIDATE_NAME_AND_EMAIL_AND_PHONE + NON_VALID_FIELD_NAME)
//        .param(SORT, NAME)
//        .param(ORDER, ASC))
//        .andExpect(status().isOk());
//
...
//
//    final SearchOptions searchOptions =
//        SearchOptions.builder().name(NON_VALID_CANDIDATE_NAME).email(StringUtils.EMPTY)
//            .phone(StringUtils.EMPTY).build();
//    final FilterRequest filterRequest = FilterRequest.builder().order(SortingRequest.Order.ASC)
//        .fieldName(SortingRequest.Field.NAME).searchOptions(searchOptions).build();
//
...
//      throws Exception {
//    final SearchOptions searchOptions =
//        SearchOptions.builder().name(CANDIDATE_NAME).email(StringUtils.EMPTY)
//            .phone(StringUtils.EMPTY).build();
//    final FilterRequest filterRequest = FilterRequest.builder().order(SortingRequest.Order.ASC)
//        .fieldName(SortingRequest.Field.NAME).searchOptions(searchOptions).build();
//
...
//      throws Exception {
//    final SearchOptions searchOptions =
//        SearchOptions.builder().name(StringUtils.EMPTY).email(CANDIDATE_EMAIL)
//            .phone(CANDIDATE_PHONE).build();
//    final FilterRequest filterRequest = FilterRequest.builder().order(SortingRequest.Order.ASC)
//        .fieldName(SortingRequest.Field.NAME).searchOptions(searchOptions).build();
//
//    ArgumentCaptor<FilterRequest>
...
//
//    final SearchOptions searchOptions =
//        SearchOptions.builder().name(CANDIDATE_NAME).email(CANDIDATE_EMAIL).phone(CANDIDATE_PHONE)
//            .build();
//    final FilterRequest filterRequest = FilterRequest.builder().order(SortingRequest.Order.ASC)
//        .fieldName(SortingRequest.Field.NAME).searchOptions(searchOptions).build();
//
