...
public class ChannelsStepDefs {
  ...
  public void error_message_appears_message(String message) throws Throwable {
    ...
    wait.until(
        visibilityOfElementLocated(By.cssSelector("#channel-form #errorMessageForCreating")));
    assertThat(
        getDriver().findElement(By.cssSelector("#channel-form #errorMessageForCreating")).getText(),
  ...
  private void waitChannelTableUntilPresentChannelName(String channelName) {
    ...
    webDriverWait.until(ExpectedConditions
        .textToBePresentInElement(getDriver().findElement(By.cssSelector("table#channels tbody")),
            channelName));
  }
}
