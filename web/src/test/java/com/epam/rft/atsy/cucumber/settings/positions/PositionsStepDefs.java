...
public class PositionsStepDefs {
    ...
    public void the_new_position_appears_in_the_list_of_positions(String name) throws Throwable {
        waitForAjax();
        assertThat(getDriver().findElement(By.cssSelector("table#positions tbody")).getText(), containsString(name));
    }
    ...
    public void error_message_appears_message(String message) throws Throwable {
        ...
        assertThat(getDriver().findElement(By.cssSelector("#position-form .error-message")).getText(), containsString(message));
    }

    @And("^the list saved$")
    public void the_list_saved() throws Throwable {
        positionsListContents = getDriver().findElement(By.cssSelector("table#positions tbody")).getText();
    }

    @Then("^the list of positions left unchanged$")
    public void the_list_of_positions_left_unchanged() throws Throwable {

        assertThat(getDriver().findElement(By.cssSelector("table#positions tbody")).getText(), is(positionsListContents));
    }
    ...
    public void the_list_of_positions_changed() throws Throwable {
        waitForAjax();
        assertThat(getDriver().findElement(By.cssSelector("table#positions tbody")).getText(), is(not(containsString(positionName))));
    }
}
