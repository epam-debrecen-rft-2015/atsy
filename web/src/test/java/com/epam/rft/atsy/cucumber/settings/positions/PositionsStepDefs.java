...
public class PositionsStepDefs {
    ...
    @And("^the options screen appears$") public void the_options_screen_appears() throws Throwable {
    ...
    @And("^the positions link is clicked$") public void the_positions_link_is_clicked()
        throws Throwable {
        getDriver().findElement(By.id("positions_link")).click();
    }

    @And("^the positions screen appears$") public void the_positions_screen_appears()
        throws Throwable {
        WebDriverWait wait = new WebDriverWait(getDriver(), 5);
    ...
    public void the_list_filled_with_positions_appears_on_the_page() throws Throwable {
        int elementCount =
            getDriver().findElements(By.cssSelector("table#positions tbody tr")).size();
        assertThat(elementCount, greaterThan(0));
    }

    @When("^the Új pozíció button clicked$") public void the_new_position_button_clicked()
        throws Throwable {
    ...
    @Then("^error message appears (.*)$") public void error_message_appears_message(String message)
        ...
        assertThat(
            getDriver().findElement(By.cssSelector("#position-form .error-message")).getText(),
    ...
    public void the_Edit_button_clicked_on_a_position() throws Throwable {
        List<WebElement> rows =
            getDriver().findElements(By.cssSelector("table#positions tbody tr"));
    ...
    @Then("^the list of positions changed$") public void the_list_of_positions_changed()
        throws Throwable {
        waitForAjax();
        assertThat(getDriver().findElement(By.cssSelector("table#positions tbody")).getText(),
