...
@Service public class ApplicationsServiceImpl implements ApplicationsService {
    ...
    @Override public Long saveOrUpdate(ApplicationDTO applicationDTO) {
        ...
        ApplicationEntity applicationEntity =
            modelMapper.map(applicationDTO, ApplicationEntity.class);
        applicationEntity
            .setCandidateEntity(candidateRepository.findOne(applicationDTO.getCandidateId()));
        applicationEntity
            .setPositionEntity(positionRepository.findOne(applicationDTO.getPositionId()));
        applicationEntity
            .setChannelEntity(channelRepository.findOne(applicationDTO.getChannelId()));
