...
@Service @Slf4j public class PositionServiceImpl implements PositionService {
    ...
    @Override public Collection<PositionDTO> getAllPositions() {
    ...
    @Override public void saveOrUpdate(PositionDTO position) {
