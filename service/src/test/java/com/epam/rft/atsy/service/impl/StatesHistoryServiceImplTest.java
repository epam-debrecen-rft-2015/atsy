...
public class StatesHistoryServiceImplTest {
  ...
  public void getStatesByApplicationIdShouldReturnAListWithSingleElement() {
    ...
    given(
        modelMapper.map(statesHistoryEntityListWithSingleElement, STATE_HISTORY_VIEW_DTO_LIST_TYPE))
  ...
  public void getStatesByApplicationIdShouldReturnAListWithThreeElement() {
    ...
    given(
        modelMapper.map(statesHistoryEntityListWithThreeElements, STATE_HISTORY_VIEW_DTO_LIST_TYPE))
