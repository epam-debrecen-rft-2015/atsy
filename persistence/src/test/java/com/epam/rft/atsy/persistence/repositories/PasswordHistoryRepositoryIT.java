...
@Sql("classpath:sql/passwordhistory/passwordhistory.sql") public class PasswordHistoryRepositoryIT
    ...
    private static final String TEST_PASSWORD_1_FOR_USER_WITH_THREE_PASSWORD_HISTORY =
        "password_history1";
    private static final String TEST_PASSWORD_2_FOR_USER_WITH_THREE_PASSWORD_HISTORY =
        "password_history2";

    private static final String ACTUAL_PASSWORD_FOR_USER_WITH_THREE_PASSWORD_HISTORY =
        "$2a$04$QSJkUouEDGfbWAtuxnlf/.Ajen6lviIhrNwKFPPZ.juRn6nLgvBi6";

    @Autowired private PasswordHistoryRepository repository;

    @Autowired private UserRepository userRepository;

    @Test public void findByUserEntityShouldNotFindPasswordHistoryForUserWithoutPasswordHistory() {
        //Given
        UserEntity user =
            this.userRepository.findByUserName(TEST_USERNAME_WITHOUT_PASSWORD_HISTORY);
    ...
    public void findByUserEntityShouldFindSinglePasswordHistoryForUserWithSinglePasswordHistory() {
        //Given
        UserEntity user =
            this.userRepository.findByUserName(TEST_USERNAME_WITH_SINGLE_PASSWORD_HISTORY);
    ...
    public void findByUserEntityShouldFindThreePasswordHistoryForUserWithThreePasswordHistory() {
        //Given
        UserEntity user =
            this.userRepository.findByUserName(TEST_USERNAME_WITH_THREE_PASSWORD_HISTORY);
        Date nearNow = currentDateMinus(5);
        ...
        assertPasswordHistoryEntity(result.get(1), user,
            TEST_PASSWORD_1_FOR_USER_WITH_THREE_PASSWORD_HISTORY, nearNow);

        assertPasswordHistoryEntity(result.get(2), user,
            TEST_PASSWORD_2_FOR_USER_WITH_THREE_PASSWORD_HISTORY, nearNow);
    ...
    public void findTop1ByUserEntityIdOrderByChangeDateShouldNotFindPasswordHistoryForUserWithoutPasswordHistory() {
        //Given
        Long testUserIdWithoutPasswordHistory =
            this.userRepository.findByUserName(TEST_USERNAME_WITHOUT_PASSWORD_HISTORY).getId();

        //When
        PasswordHistoryEntity pwHistory = this.repository
            .findTop1ByUserEntityIdOrderByChangeDate(testUserIdWithoutPasswordHistory);
    ...
    public void findTop1ByUserEntityIdOrderByChangeDateShouldfindTop1ByUserEntityIdOrderByChangeDateHistoryForUserWithThreePasswordHistory() {
        ...
        //When
        PasswordHistoryEntity pwHistory = this.repository
            .findTop1ByUserEntityIdOrderByChangeDate(testUserIdWithThreePasswordHistory);

        //Then
        assertThat(pwHistory, notNullValue());
        assertPasswordHistoryEntity(pwHistory, user,
            ACTUAL_PASSWORD_FOR_USER_WITH_THREE_PASSWORD_HISTORY, nearNow);
    }

    private void assertPasswordHistoryEntity(PasswordHistoryEntity actual,
        UserEntity expectedUserEntity, String expectedPassword, Date currentDate) {
