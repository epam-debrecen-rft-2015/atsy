...
public class PasswordHistoryRepositoryIT extends AbstractRepositoryIT {
  ...
  private static final String
      ACTUAL_PASSWORD_FOR_USER_WITH_THREE_PASSWORD_HISTORY =
  ...
  public void findTop1ByUserEntityIdOrderByChangeDateShouldNotFindPasswordHistoryForUserWithoutPasswordHistory() {
    //Given
    Long
        testUserIdWithoutPasswordHistory =
        this.userRepository.findByUserName(TEST_USERNAME_WITHOUT_PASSWORD_HISTORY).getId();

    //When
    PasswordHistoryEntity
        pwHistory =
        this.repository.findTop1ByUserEntityIdOrderByChangeDate(testUserIdWithoutPasswordHistory);
  ...
  public void findTop1ByUserEntityIdOrderByChangeDateShouldfindTop1ByUserEntityIdOrderByChangeDateHistoryForUserWithThreePasswordHistory() {
    ...
    PasswordHistoryEntity
        pwHistory =
        this.repository.findTop1ByUserEntityIdOrderByChangeDate(testUserIdWithThreePasswordHistory);
